...
PREFABS = {
    ...
    'house-blue':   dict(w=3, h=4, sprites=[('Tops', 0, 0, 'building-roof-blue_0_0'), ('Collidables', 0, 3, 'building-entrance-1_0_0')],
                         colliders=[(x, y) for x in range(3) for y in (1, 2, 3) if (x, y) != (1, 3)], doors=[(1, 3)]),
    'house-red':    dict(w=3, h=4, sprites=[('Tops', 0, 0, 'building-roof-red_0_0'), ('Collidables', 0, 3, 'building-entrance-3_0_0')],
                         colliders=[(x, y) for x in range(3) for y in (1, 2, 3) if (x, y) != (1, 3)], doors=[(1, 3)]),
    'house-black':  dict(w=3, h=4, sprites=[('Tops', 0, 0, 'building-roof-black_0_0'), ('Collidables', 0, 3, 'building-entrance-2_0_0')],
                         colliders=[(x, y) for x in range(3) for y in (1, 2, 3) if (x, y) != (1, 3)], doors=[(1, 3)]),
